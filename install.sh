...
SCAN_TCP_VERTICAL_PORTS="$(config_positive_or_default "$CONFIG_DIR/settings.env" EZHIK_SCAN_TCP_VERTICAL_PORTS 50)"
SCAN_UDP_VERTICAL_PORTS="$(config_positive_or_default "$CONFIG_DIR/settings.env" EZHIK_SCAN_UDP_VERTICAL_PORTS 100)"
...
SCAN_SUBNET_ENDPOINTS="$(config_positive_or_default "$CONFIG_DIR/settings.env" EZHIK_SCAN_SUBNET_ENDPOINTS 100)"
...
EZHIK_SCAN_TCP_VERTICAL_PORTS=$SCAN_TCP_VERTICAL_PORTS
EZHIK_SCAN_UDP_VERTICAL_PORTS=$SCAN_UDP_VERTICAL_PORTS
EZHIK_SCAN_SUBNET_HOSTS=$SCAN_SUBNET_HOSTS
EZHIK_SCAN_SUBNET_PORTS=$SCAN_SUBNET_PORTS
EZHIK_SCAN_SUBNET_ENDPOINTS=$SCAN_SUBNET_ENDPOINTS
