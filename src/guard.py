...
SCAN_TCP_VERTICAL_PORTS = _env_int("EZHIK_SCAN_TCP_VERTICAL_PORTS", 50, minimum=2)
SCAN_UDP_VERTICAL_PORTS = _env_int("EZHIK_SCAN_UDP_VERTICAL_PORTS", 100, minimum=2)
...
SCAN_SUBNET_ENDPOINTS = _env_int("EZHIK_SCAN_SUBNET_ENDPOINTS", 100, minimum=2)
...
SCAN_DETECTOR = scan_detector.ScanDetector(
    ...
    tcp_vertical_ports=SCAN_TCP_VERTICAL_PORTS,
    udp_vertical_ports=SCAN_UDP_VERTICAL_PORTS,
    subnet_hosts=SCAN_SUBNET_HOSTS,
    subnet_ports=SCAN_SUBNET_PORTS,
    subnet_endpoints=SCAN_SUBNET_ENDPOINTS,
